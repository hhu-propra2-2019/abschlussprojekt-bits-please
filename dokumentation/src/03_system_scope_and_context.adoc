...
Die Eingabe von Daten erfolgt manuell oder per hochladen von Dateien über die UI. Die Ausgabe erfolgt über den Bildschirm oder als Export von Dateien.
Interaktion mit Fremdsystemen gibt es nicht.
